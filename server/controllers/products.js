...
module.exports={
    CreateProduct:((req,res)=>{
        const query = `INSERT INTO products(product_name,description,Origin_price,quantity,Promo_price,Product_material, product_image,availability,catigory,check_add_or_not) VALUES("${req.body.product_name}","${req.body.description}",${req.body.Origin_price},${req.body.quantity},${req.body.Promo_price},"${req.body.Product_material}","${req.body.product_image}","${req.body.availibility}","${req.body.catigory}",${false})`;
